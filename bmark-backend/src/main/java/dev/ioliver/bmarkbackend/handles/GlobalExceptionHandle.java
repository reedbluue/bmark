package dev.ioliver.bmarkbackend.handles;

import dev.ioliver.bmarkbackend.dtos.exception.DefaultExceptionResponse;
import dev.ioliver.bmarkbackend.dtos.exception.DefaultValidationExceptionResponse;
import dev.ioliver.bmarkbackend.exceptions.DefaultException;
...
public class GlobalExceptionHandle {
  ...
  public ResponseEntity<DefaultExceptionResponse> httpMessageNotReadable(
